...
public class DataManager: ObservableObject {
    ...
    /// Refreshes match data for a summoner
    ...
    private func loadChampionForParticipant(_ participant: Participant) async {
        do {
            ...
            // Try to find champion by ID first, then by key as fallback
            ...
            // Silently handle errors - champion will remain nil
        }
    }
    ...
    public func getMatches(for summoner: Summoner, limit: Int = 20) async throws -> [Match] {
