    ...
    private func loadData() async {
        ...
        do {
            ...
            if existingMatches.isEmpty {
                ...
                print("📊 [PerformanceView] Found \(existingMatches.count) existing matches, checking for new ones")
    ...
    private func calculateKPIs() async {
        do {
            ...
            let roleMatches = matches.filter { match in
                match.participants.contains { $0.puuid == summoner.puuid && RoleUtils.normalizeRole($0.role, lane: $0.lane) == userSession.selectedPrimaryRole }
            }
