    ...
    private func testPerformanceAnalysis() async {
        ...
        do {
            ...
            await MainActor.run {
                ...
                self.testResults.append("Overall Score: \(String(format: "%.1f", analysis.overallScore))")
            ...
            await MainActor.run {
                self.errorMessage = "Failed to test performance analysis: \(error.localizedDescription)"
                self.isLoading = false
            }
        }
    }
